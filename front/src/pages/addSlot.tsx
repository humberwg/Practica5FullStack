/*
  El renderizado se genera el cliente (CSR), lo cual es adecuado por la interactividad en tiempo real con el usuario, la acción de agregar un slot no es necesario
